---
title: "Toronto may recover from Coronavirus if adult avoid go out"
author: "Peihan Gong"
date: 2020-09-24
categories: ["R"]
...
Coronavirus is a hard problem facing by the whole world, and seriously impact our daily life. We cannot cure patients or develop a vaccine to stop the spread ofCoronavirus but we can find the common points of the people who suffer from the Coronavirus and help the public avoid being infected.

By analyzing the data we find that both male and female has a equal chance of being infected. Besides, the main group of people suffer from Coronavirus are the adult age from 20 to 59 and the main source of infection is close 
...
- David Meyer, Achim Zeileis, and Kurt Hornik (2020). vcd: Visualizing Categorical Data. R
...
- Hadley Wickham, Jim Hester and Romain Francois (2018). readr: Read Rectangular Text Data.
  R package version 1.3.1. https://CRAN.R-project.org/package=readr
